      ...
      <section class="hero-section-two">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-two-texr">
                        <h1>Secure Solutions For Digital Assets and Money Easily</h1>
                        <p>This app you definitely want to use while you’re planning a trip and before you buy any
                            tickets</p>
                        <a href="#" class="btn">Start A 10-Day Free Trial</a>
                        ...
                        <img src="/assets/img/hero-shaps.png" alt="hero-shaps" class="hero-shaps">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="hero-two-img">
                        <img src="https://placehold.co/476x581" alt="hero-mobil">
                        <img src="/assets/img/hero-icon.png" alt="hero-icon.png" class="hero-icon">
                        <div class="use-app">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="intelligent">
                        <h2>Intelligent Apps for Every Business Model</h2>
                        <img src="https://placehold.co/589x658" alt="intelligent">
                ...
                <div class="col-lg-6">
                    <div class="intelligent-text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,sed eius to massa. Lorem ipsum dolor
                            sit amet,to mod tempor incididunt Lorem incididunt ut labore et dolore magna aliqua. Ut
                            enims ad minim veni massa.Lorem ipsum dolor sit amet,to mod tempor incididunt <br><br>Lorem
                            ipsum dolor sit amet, consectetur adipisicing elit,sed eius to incididunt ut labore et
                            dolore magna aliqua. Ut enims ad minim veni massa. Lorem ipsum dolor sit amet,to mod tempor
                            incididunt</p>
                        <div class="row">
                            <div class="col-md-6">
                                <i><img src="/assets/img/intelligent-icon-1.png" alt="intelligent-icon"></i>
                                <a href="#">
                                    <h4>Security Certified</h4>
                                </a>
                                <p>adipisicing elit,sed eius to inci didunt ut labore et dolore </p>
                            </div>
                            <div class="col-md-6">
                                <i class="two"><img src="/assets/img/intelligent-icon-2.png" alt="intelligent-icon"></i>
                                <a href="#">
                        ...
                        <div class="video position-relative">
                            ...
                            <img src="https://placehold.co/636x348" alt="img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="gap no-top">
        <div class="container">
            <div class="heading">
                ...
                <h6>steps to take to successfully run</h6>
                <h2>Take Full Control of Your Crypto App</h2>
            </div>
            <div class="steps-run">
                <div class="steps">
                    <i><img src="/assets/img/steps-1.png" alt="steps"></i>
                    <span>1</span>
                    <h4>Download from the Play Store on any device</h4>
                    <p>download the app from the App Store or Google Play on any device</p>
                </div>
                <div class="steps">
                    <i><img src="/assets/img/steps-2.png" alt="steps"></i>
                    <span>2</span>
                    <h4>Create an account with needful information</h4>
                    <p>download the app from the App Store or Google Play on any device</p>
                </div>
                <div class="steps">
                    <i><img src="/assets/img/steps-3.png" alt="steps"></i>
                    <span>3</span>
                    <h4>Choose crypto & explore the world</h4>
                    <p>download the app from the App Store or Google Play on any device</p>
                </div>
            </div>
        </div>
    </section>
    <section class="section-mobil" style="background-image: url(/assets/img/footer.jpg);">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="img-mobil">
                        <img src="https://placehold.co/591x581" alt="mobil">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="download-app">
                        <h2>Download and learning the crypto App</h2>
                        <p>The crypto app lets you create your own workouts based on your goals. Download on any device
                        ...
                        <div class="d-sm-flex">
                            ...
                            <a href="#"><img class="ms-sm-3 mt-sm-0 mt-2" src="/assets/img/apple.png" alt="apple"></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="gap blog-section" style="background-image: url(/assets/img/background-1.png);">
        <div class="container">
            <div class="heading">
                ...
                <h2>The best application features you won't find anywhere</h2>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="solutions">
                        <i><svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
                                <g>
                        ...
                        <p>Lorem ipsum dolor sit amet, cons ec tetur adipiscing elit, sed do eiu smod m ipsum dolo
                            tempor.</p>
                    </div>
                    <div class="solutions two mb-0">
                        <i><svg id="Layer_1" enable-background="new 0 0 68 68" height="512" viewBox="0 0 68 68"
                ...
                <div class="col-lg-4">
                    <div class="solutions-img">
                        <img src="https://placehold.co/423x356" alt="solutions">
                    </div>
                    <div class="solutions">
                        <i><svg enable-background="new 0 0 468 468" height="512" viewBox="0 0 468 468" width="512"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                ...
                <div class="col-lg-4">
                    <div class="solutions three">
                        <i><svg enable-background="new 0 0 64 64" height="512" viewBox="0 0 64 64" width="512"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                    ...
                    <div class="solutions for mb-0">
                        <i><svg height="512" viewBox="0 0 66 66" width="512" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <g>
                                        <g>
                                            <g
                                                style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-width:1.5">
                                                <path d="m49 41.6v-24.6" />
                                                <path d="m17 59.3v1.9c0 1.7 1.4 3 3 3h26c1.7 0 3-1.4 3-3v-3.2" />
                                                <path d="m49 5.6v-.8c0-1.7-1.4-3-3-3h-26c-1.7 0-3 1.4-3 3v41.5" />
                                            </g>
                                            <g>
                                                <g>
                                                    <g>
                                    ...
                                    <g
                                        ...
                                        <g>
                                            ...
                                            <path d="m27.6 38.1c0-3 2.4-5.4 5.4-5.4s5.4 2.4 5.4 5.4" />
                                        </g>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="d-flex align-items-center phone">
                        <span>Phone No. <a href="callto:88(9800)6802">+88(9800) 6802</a></span>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="accordio-img-style">
                        <img src="https://placehold.co/383x414" alt="accordio-img" class="accordio-img-1">
                        <img src="https://placehold.co/383x414" alt="accordio-img" class="accordio-img-2">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="accordion two">
                        <div class="accordion-item">
                            ...
                            <div class="content">
                                <p>Lorem Ipsum estibulum blandit libero at mauris condime ntummales uada scelerisque in
                                    mauris ut malesuada. Ute littellus, luctus estibulum blandit libero at manec.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <a href="javascript:void(0)" class="heading">
                                <div class="icon"></div>
                                <div class="title">What apps are needed for cryptocurrency?</div>
                            </a>
    ...
    <section class="gap no-top">
        <div class="container">
            ...
            <div class="screenshots-slider owl-carousel owl-theme">
                <div class="item">
                    <img src="https://placehold.co/270x560" alt="screenshots">
                </div>
                <div class="item">
                    <img src="https://placehold.co/270x560" alt="screenshots">
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="pricing">
                                ...
                                <div class="professional-text"
                                    ...
                                    <ul class="list">
                                        <li><img src="/assets/img/check.png" alt="check">Up to 10 Website</li>
                                        <li><img src="/assets/img/check.png" alt="check">Lifetime free Support</li>
                                        <li><img src="/assets/img/check.png" alt="check">10 GB Hosting free</li>
                                        <li><img src="/assets/img/check.png" alt="check">24/7 Support</li>
                                    </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-style img-hover">
                        <figure>
                            <img src="https://placehold.co/401x323" alt="img">
                        </figure>
                        <div class="blog-style-text">
                            <h6><span>Branding</span> - December 13, 2022</h6>
                            <a href="#">How to build the Best IT Solutions Company</a>
                            <p>Lorem Ipsum estibulum blandit libero at erisque in mauris ut malesuada. Ute litte ero at
                                mauris condimmanec.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-style img-hover mb-0">
                        <figure>
                            <img src="https://placehold.co/401x323" alt="img">
                        </figure>
                        <div class="blog-style-text">
            ...
            <div class="trusted-by">
                ...
                <div class="logodata owl-carousel owl-theme">
                    <div class="partner item">
                        <img alt="clients-logo" src="https://placehold.co/172x80">
                    </div>
                    <div class="partner item">
                        <img alt="clients-logo" src="https://placehold.co/172x80">
                    </div>
